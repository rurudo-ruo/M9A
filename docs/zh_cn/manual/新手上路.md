...
<summary>展开 MAA 模拟器和设备支持文档</summary>
...
![主界面](https://github.com/user-attachments/assets/540d961e-47ce-490d-a801-89d802f2bbab)
...
<details open>
  ...
  <blockquote>
    <ul>
      ...
      <li>
        <b>CDK 或 Token</b>：Mirror 酱 CDK 或 GitHub Personal Access Token 。
        <ul>
          <li>通过 Mirror 酱更新的用户应当填写 CDK ，否则无法更新。<a href="https://mirrorchyan.com/zh/get-start?rid=MFAAvalonia%5E&source=mfaa-software" target="_blank">关于 Mirror 酱</a></li>
          <li>通过 GitHub 更新的用户可以填写 token 。填写 token 有助于缓解 GitHub 封堵更新 API 。<a href="https://github.com/settings/tokens" target="_blank">关于 Token</a> </li>
          <li><img src="https://github.com/user-attachments/assets/69192c43-f257-40ba-b5d0-918e6b508f80" alt="rate limit exceeded"></li>
        </ul>
      </li>
    </ul>
  </blockquote>
...
您至少应当配置 **`资源类型`** 和 **`连接`** 。配置错误时将无法使用 M9A 。
  ...
  <details open>
            ...
            <details>
              ...
              <blockquote>
                <ul>
                  ...
                  <li>一般情况下只需在这里选择正确的模拟器和 ADB 地址组合即可连接。</li>
                </ul>
              </blockquote>
            </details>
          </li>
    ...
    <details open>
      ...
      <blockquote>
        <ul>
          <li><img src="https://github.com/user-attachments/assets/56b031b4-db6c-40a4-85a6-557fe5f4ad80" alt="image_441"></li>
