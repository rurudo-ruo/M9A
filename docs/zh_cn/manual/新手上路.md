  ...
  <blockquote>
    <ul>
      ...
      <details open>
        ...
        <ul>
          <li>通过 Mirror 酱更新的用户应当填写 CDK 。<a href="https://mirrorchyan.com/zh/get-start?rid=MFAAvalonia%5E&source=mfaa-software" target="_blank">关于 Mirror 酱</a></li>
        ...
        <ul>
          <li>请自行寻找各模拟器的安装目录</li>
            <table>
              ...
              <tbody>
                <tr>
                  <td>MuMu 模拟器<br>5.0 以下</td>
                  <td><code>{安装目录}\shell\MuMuPlayer.exe</code></td>
                </tr>
                <tr>
                  <td>MuMu 模拟器<br>5.0 及以上</td>
